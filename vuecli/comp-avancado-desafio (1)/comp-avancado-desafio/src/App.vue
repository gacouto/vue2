<template>
  <div id="app">
    <span>
      <button class="vermelho" @click="selectedComponent='Vermelho'">Carregar Componente Vermelho</button>
      <button class="verde" @click="selectedComponent='Verde'">Carregar Componente Verde</button>
